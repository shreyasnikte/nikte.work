...
Since November 2025, AI's coding capabilities have been significantly improved. Specifically, Claude Opus 4.5 and newer GPT 5.4 have been a game-changer for coding. For most cases, writing actual lines of code is a thing of the past. As long as you are working with popular languages, standard frameworks, and not developing the next five-nines (99.999% uptime) system, AI code generation is simply going to be as good as or even better than most software engineers. Going a step further, I realised that if I follow a specific sequence of steps, the output is accurate in close to 95% of cases. 
