...
Here, I would like to document my AI workflow for development tasks. Familiar tasks are easy - ask AI for a targeted change. The problem arises when I am not familiar with software patterns. If I could not define a proper scope, I would lose control of the blast radius - resulting in mediocre output. Learning from experience, I have converged on the following method, which has consistently given me good results.
